  ...
  <section id="adopt-form" class="pb-2">
    <div class="container-fluid p-5 d-flex justify-content-center">
      <div class="border p-4 w-50 bg-light rounded-3 shadow-sm w-sm-90 w-md-75 w-lg-50 w-xl-40 mx-auto">
        <h2 class="text-center text-dark pt-5">Login</h2>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
          <div class="m-5">
            <div class="mb-3">
              <label for="adopt-username" class="form-label text-dark">Username:</label>
              <input type="text" class="form-control bg-dark bg-opacity-25 <?php echo $borderColorUsername; ?>" id="adopt-username" name="adopt-username" placeholder="Enter Username" value="<?php echo htmlspecialchars($username); ?>">
              <div class="text-danger"><?php echo htmlspecialchars($adoptErrors['username']); ?></div>
            </div>

            <div class="mb-3">
              <label for="adopt-password" class="form-label text-dark">Password:</label>
              <input type="password" class="form-control w-100 bg-dark bg-opacity-25 <?php echo $borderColorPassw; ?>" id="adopt-password" name="adopt-password" placeholder="Enter Password" value="<?php echo htmlspecialchars($adoptPassword); ?>">
