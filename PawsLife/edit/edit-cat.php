            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mt-3 d-flex justify-content-center">
                  ...
                  <div class="col-lg-5 col-12 mb-3">
                    ...
                    <input type="file" class="form-control w-100  bg-dark bg-opacity-25 <?php echo $catPhotoInputBorderColor?>" id="cat-photo-data" name="cat-photo-data" accept="image/*" value="<?php echo htmlspecialchars($catNameInput); ?>">
                  ...
                  <div class="mb-3 col-lg-5 col-12">
                   ...
                   <div class="text-center mt-3">
                      <button class="btn btn-success w-25 mb-5" id="adoption-form-btn" name="cat-form-btn">Submit</button>
                   </div>
