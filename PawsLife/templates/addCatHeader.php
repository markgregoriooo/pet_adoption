...
<header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark container-fluid " id="nav-container">
            <div class="container">
                ...
                <!-- add cat button -->
                <div class="m-2">
                    <a type="button" class=" text-light btn btn-success" href="../pagesForAdding/addCat.php">Add Cat</a>
                </div>
                
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a href="../admin.php" class="fa-solid fa-left-long ms-1 fs-3" id="home-icon"></a>
                        </li>
                    </ul>
                </div>
            </div>
