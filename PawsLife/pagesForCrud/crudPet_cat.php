...
//execute
if (!$stmt->execute()) {
  // if there is/are error, echo the error
...
<section class="bg-secondary">
  ...
  <div class="container">
    <div class="row ">
      <!-- fooreach loop to displat each cat -->
          ...
          <div class="card g-3 mx-auto mt-5 mb-5 border border-dark" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-evenly">
                <!-- details btn to pass the cat's info into js and show in modal -->
                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#cat_details"
                  ...
                  data-cat-created="<?php echo htmlspecialchars($cat['created_at']); ?>">Details
                </button>
                <!-- include modal file -->
