...
<section class="bg-secondary">
  ...
  <div class="container">
    <div class="row g-3">
      <!-- foreach loop to display each adopter -->
          ...
          <div class="card mx-auto border border-dark" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-evenly">
                 <!-- details btn to pass the adopter's info into js and show in modal -->
                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#adopter_details"
                  ...
                  data-adopter-created="<?php echo htmlspecialchars($adopter['created_at']); ?>">Details
                </button>
                <!-- include modal -->
