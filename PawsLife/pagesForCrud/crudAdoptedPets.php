          ...
          <div class="card g-3 mx-auto mt-3 mb-3 border border-dark" style="width: 18rem;">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-evenly">
                 <!-- details btn to pass the adopted pet's info into js and show in modal -->
                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#adopted_pet_details"
                  ...
                  data-adopter-contact="<?php echo htmlspecialchars($adopted_pet['adopter_phone_number']); ?>">Details
                </button>
                <!-- include modal -->
