<?php 
    ...
    if(isset($_POST['login'])){
        ...
        // // Check if there are errors, if so stay on the login page
        // if(array_filter($adoptErrors)){
        //     // Error exists, display errors in the form
        // } else {
        //     // Form submission is successful, you can proceed with further actions if needed
        // }
