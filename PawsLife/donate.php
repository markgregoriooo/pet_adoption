            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
              <div class="m-5">
                ...
                <div class="col-lg-5 col-12 mb-3">
                      <label for="edit-adopter-photo-data" class="form-label">Upload Photo<label class="text-danger">&nbsp;*</label></label>
                      <input type="file" class="form-control w-100 bg-dark bg-opacity-25 border border-dark" id="edit-adopter-photo-data" name="edit-adopter-photo-data" accept="image/*" >
